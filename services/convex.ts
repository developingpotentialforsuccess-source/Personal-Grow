...
const CONVEX_URL = ((typeof import.meta !== 'undefined' && import.meta.env && import.meta.env.VITE_CONVEX_URL) || (typeof process !== 'undefined' && process.env?.CONVEX_URL) || "https://dapper-robin-600.convex.cloud").replace(/\/$/, "");
